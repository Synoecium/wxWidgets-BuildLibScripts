...
del "CMakeCache.txt"
cmake -G "MinGW Makefiles" -DwxBUILD_SHARED=ON -DCMAKE_BUILD_TYPE=Debug
...
cmake -G "MinGW Makefiles" -DwxBUILD_SHARED=ON -DwxBUILD_DEMOS=ON -DCMAKE_BUILD_TYPE=Release
cmake --build .
if %errorlevel% neq 0 goto:exit
